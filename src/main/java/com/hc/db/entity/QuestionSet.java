...
public class QuestionSet {
	...
	public QuestionSet(Long question_set_id, Long category_id, Date created_on, Long created_by, Date modified_on, Long modified_by,
			Date deleted_on, Long deleted_by) {
		super();
	...
	public String toString() {
		return "QuestionSet [question_set_id=" + question_set_id + ", category_id=" + category_id + ", created_on="
